...
const int ledPin = D4; // LED connected to pin D4
const int buttonPin = D5; // Button connected to pin D5 

// WiFi
const char* ssid     = "FalconVille";      // SSID of local network
const char* wifi_password = "Pa55wordfalcon!";   // Password on network

// MQTT
// Make sure to update this for your own MQTT Broker!
const char* mqtt_server = "192.168.50.125";
const char* mqtt_topic = "Motion_Detector";
